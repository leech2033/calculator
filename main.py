# ch 4,2,3 main.py
import sys
from PyQt5.QtWidgets import (QApplication, QWidget, QPushButton,QVBoxLayout,QMessageBox) #QMessageBox : 메시지 박스 위젯
from PyQt5.QtGui import QIcon # icon을 추가하는 라이브러리
